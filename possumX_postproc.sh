...
echo Copying KspaceTrack2
run "cp ${subjdir}/diff_proc/signal_proc_0_kcoord_mot ${subjdir}/Kcoord_mot_bin" ${subjdir}

echo Copying MotionGradients
run "cp ${subjdir}/diff_proc/signal_proc_0_Grad1_Mot_ascii ${subjdir}/Grad1_Mot_ascii" ${subjdir}
run "cp ${subjdir}/diff_proc/signal_proc_0_Grad2_Mot_ascii ${subjdir}/Grad2_Mot_ascii" ${subjdir}
